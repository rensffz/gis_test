...
class _ObjectMapScreenState extends ConsumerState<ObjectMapScreen>
  ...
  Widget _buildPointPopup(Size mapSize, List<GisLayer> layers) {
    ...
    final screenPt =
        _mapController.camera.latLngToScreenPoint(LatLng(p.lat, p.lng));
    ...
    final left =
        (screenPt.x - popupW / 2).clamp(8.0, mapSize.width - popupW - 8.0);
    final top = (screenPt.y - popupH - gap)
        .clamp(8.0, mapSize.height - popupH - 48.0);
  ...
  Widget build(BuildContext context) {
    ...
    final coordLabel =
        '${_mapCenter.latitude.toStringAsFixed(4)}°N  ${_mapCenter.longitude.toStringAsFixed(4)}°E';
    final zoomLabel = 'z${_mapZoom.toStringAsFixed(1)}';
    ...
    return Scaffold(
      key: _scaffoldKey,
      backgroundColor:
          isDark ? const Color(0xFF0F1520) : AppColors.bgLight,
      appBar: AppBar(
        backgroundColor:
        ...
        actions: [
          ...
          IconButton(
              icon: Icon(Icons.layers_rounded, color: iconColor),
              onPressed: () =>
      ...
      body: LayoutBuilder(builder: (_, constraints) {
        ...
        return Stack(children: [
          ...
          FlutterMap(
            ...
            options: MapOptions(
              ...
              onPositionChanged: (camera, hasGesture) {
                setState(() {
                  ...
                  if (hasGesture && _selectedPointIndex != null) {
                    _selectedPointIndex = null;
                  }
                });
              },
            ...
            children: [
              // Base map: CartoDB dark/light depending on theme
              TileLayer(
                urlTemplate: isDark
              ...
              // Orthophoto mock: ESRI World Imagery satellite tiles.
              // Replace urlTemplate with TiTiler endpoint when server is ready.
              if (hasOrthophoto)
                Opacity(
                  opacity: 0.9,
                  child: TileLayer(
              ...
              if (hasPoints)
                MarkerLayer(
                  markers: _demoPoints.asMap().entries.map((e) {
                    final p = e.value;
                    return Marker(
          ...
          Positioned(
              top: 12,
              left: 14,
              child: _CoordBadge(coordLabel, isDark: isDark)),
          Positioned(
              top: 12,
              right: 14,
              child: _CoordBadge(zoomLabel, isDark: isDark)),
          Positioned(
            right: 14,
            bottom: 90,
            child: ScaleTransition(
              ...
              child: _MapControls(
                ...
                onZoomIn: () {
                  if (_mapReady) {
                    _mapController.move(
                        _mapCenter, (_mapZoom + 1).clamp(1.0, 20.0));
                  }
                },
                onZoomOut: () {
                  if (_mapReady) {
        ...
        child: Column(children: [
          ...
          Expanded(
            ...
            data: (layers) => ListView.separated(
              ...
              itemBuilder: (_, i) =>
                  _LayerTile(layer: layers[i], objectId: objectId),
            ),
          )),
          Divider(height: 1, color: AppColors.dividerDark),
          Padding(
              ...
              child: OutlinedButton.icon(
                  onPressed: () => showDialog<void>(
                        context: context,
                        builder: (_) =>
                            _CreateLayerDialog(objectId: objectId),
                      ),
      ...
      child: Column(
        ...
        children: [
          Row(children: [
            ...
            InkWell(
                onTap: () => ref
                    .read(layersProvider(objectId).notifier)
          ...
          Padding(
              ...
              child: Row(children: [
                Container(
                    ...
                    decoration: BoxDecoration(
                        color: layer.type.color.withOpacity(0.08),
                        borderRadius: BorderRadius.circular(4)),
                    child: Text(layer.type.label,
                        style: TextStyle(
                            fontSize: 9,
                            color: layer.type.color,
                            fontWeight: FontWeight.w600))),
                const SizedBox(width: 5),
                Text('${layer.objectsCount} obj',
                ...
                if (layer.type.supportsTable && layer.tableId != null)
                  _SmBtn(Icons.table_rows_outlined, () {
                    ...
                    router.go('/tables/${layer.tableId}',
                        extra: objectId);
                  }),
                _SmBtn(Icons.edit_outlined,
                    () => showAppSnackbar(context, 'Редактировать: ${layer.name}')),
                _SmBtn(
    ...
    return DraggableScrollableSheet(
      ...
      builder: (_, ctrl) => Container(
        ...
        child: Column(children: [
          ...
          Padding(
              padding:
                  const EdgeInsets.fromLTRB(18, 8, 14, 12),
              child: Row(children: [
                Container(
                    width: 32,
                    height: 32,
                ...
                TextButton.icon(
                    onPressed: () =>
                        _showAddOptions(context, objectId),
                ...
                return Padding(
                    ...
                    child: Row(children: [
                      Container(
                          ...
                          decoration: BoxDecoration(
                              color:
                                  f.type.color.withOpacity(0.1),
                              borderRadius:
                                  BorderRadius.circular(11),
                              border: Border.all(
                                  color: f.type.color
                                      .withOpacity(0.25))),
                          child: Icon(f.type.icon,
                              color: f.type.color, size: 20)),
...
class _CreateLayerDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_CreateLayerDialog> createState() =>
      _CreateLayerDialogState();
}

class _CreateLayerDialogState
    extends ConsumerState<_CreateLayerDialog> {
  ...
  Future<void> _submit() async {
    ...
    await ref
        .read(layersProvider(widget.objectId).notifier)
        .addLayer(layer);
    if (!mounted) return;
    Navigator.pop(context);
  }
  ...
  Widget build(BuildContext context) {
    ...
    final geotiffFiles = ref
        .watch(globalFilesProvider)
        .where((f) => f.type == FileType.geotiff)
        .toList();

    return AlertDialog(
      title: const Text('Новый слой',
          style: TextStyle(
        ...
        if (_type.supportsTable) ...[
          ...
          DropdownButtonFormField<String>(
            ...
            decoration: InputDecoration(
              ...
              errorText:
                  _triedSubmit && _selectedTableId == null
                      ? 'Выберите таблицу'
                      : null,
            ),
          ),
          ...
          if (geotiffFiles.isEmpty)
            Container(
              ...
              child: const Row(children: [
                ...
                SizedBox(width: 8),
                Expanded(
                    child: Text('Нет .tif файлов в хранилище',
                        style: TextStyle(
                            fontSize: 12,
                            color: AppColors.error))),
              ]),
            ...
            DropdownButtonFormField<String>(
              ...
              items: geotiffFiles
                  ...
                  .toList(),
              onChanged: (v) =>
                  setState(() => _selectedFileId = v),
              decoration: InputDecoration(
                labelText: 'Ортофотоплан (.tif) *',
                labelStyle: const TextStyle(
                    color: AppColors.textMuted, fontSize: 13),
                errorText:
                    _triedSubmit && _selectedFileId == null
                        ? 'Выберите файл'
                        : null,
              ),
            ),
...
class _PointEditorDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<_PointEditorDialog> createState() =>
      _PointEditorDialogState();
}

class _PointEditorDialogState
    extends ConsumerState<_PointEditorDialog> {
  ...
  void _save(List<AttributeProperty> props) {
    final newAttrs =
        Map<String, String>.from(widget.point.attributes);
  ...
  Widget build(BuildContext context) {
    ...
    for (final p in props) {
      _attrCtrls.putIfAbsent(
          p.id,
          () => TextEditingController(
              text: widget.point.attributes[p.id] ?? ''));
    }

    // Real coordinates from the point model.
    final lat = widget.point.lat.toStringAsFixed(5);
    final lon = widget.point.lng.toStringAsFixed(5);
      ...
      title: Row(children: [
        Container(
            ...
            decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                      color: widget.point.color.withOpacity(0.5),
                      blurRadius: 5)
                ])),
        const SizedBox(width: 8),
          ...
          child: Column(
              ...
              children: [
                ...
                if (props.isNotEmpty) ...[
                  ...
                  const Divider(
                      height: 1, color: AppColors.dividerDark),
...
void _showAddOptions(BuildContext ctx, String objectId) {
  showModalBottomSheet<void>(
    ...
    backgroundColor: Colors.transparent,
    builder: (sheetCtx) =>
        _AddOptionsSheet(objectId: objectId, parentCtx: ctx),
  );
}
...
class _AddOptionsSheet extends StatelessWidget {
  ...
  const _AddOptionsSheet(
      {required this.objectId, required this.parentCtx});
        ...
        _OptionTile(
          ...
          onTap: () {
            ...
            showModalBottomSheet<void>(
              ...
              backgroundColor: Colors.transparent,
              builder: (_) =>
                  _StoragePickerSheet(objectId: objectId),
            );
          },
        ),
        const SizedBox(height: 10),
    ...
    return DraggableScrollableSheet(
      ...
      builder: (_, ctrl) => Container(
        ...
        child: Column(children: [
          ...
          Padding(
              padding:
                  const EdgeInsets.fromLTRB(18, 8, 10, 12),
              child: Row(children: [
                Container(
                    width: 32,
                    height: 32,
                      ...
                      child: Padding(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                const Text(
                                    'Добавьте файлы через раздел «Файлы»',
                                    style: TextStyle(
                                        fontSize: 12,
                                        color:
                                            AppColors.textMuted),
                      ...
                      itemBuilder: (_, i) {
                        ...
                        return ListTile(
                          ...
                          onTap: () {
                            ref
                                .read(repoProvider)
                                .attachFileToObject(objectId, f);
                            ref.invalidate(
                                filesProvider(objectId));
                            final sm =
